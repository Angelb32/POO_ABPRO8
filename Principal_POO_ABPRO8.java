...
public class Principal_POO_ABPRO8 {
    public static void main(String[] args) {
        ...
        Profesional_POO_ABPRO8 profesional1 = new Profesional_POO_ABPRO8("María González", "98765432-1", "Ingeniera Civil");
        Administrativo_POO_ABPRO8 administrativo1 = new Administrativo_POO_ABPRO8("Pedro García", "23456789-0", "Contabilidad");
        UsuarioAdmin_POO_ABPRO8 admin1 = new UsuarioAdmin_POO_ABPRO8("admin", "admin123", null);
        UsuarioNormal_POO_ABPRO8 normal1 = new UsuarioNormal_POO_ABPRO8("usuario", "password123", null, 1);
